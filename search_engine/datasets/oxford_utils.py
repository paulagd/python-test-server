...
def compute_map( dataset, ranks, target_names, query_names):
    #/home/eva/2017/paula_thesis/python-server/search_engine/data/datasets/oxford.pkl
    ...
    for i, name in enumerate(query_names):
        ...
        for k in range(ranks.shape[0]):
            ...
            fid.write( "{}\n".format(name.split('.')[0]) )
        fid.close()
    results = compute_ap_oxf( path_out, os.path.join( dataset, 'gt_files'))
    return results
